    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                $invoice_rs = Database::select($query);
                ...
                ?>
                    <div class="row">
                        ...
                        <?php
                        $product_rs = Database::select("SELECT * FROM `product` WHERE `id`='".$selected_data["product_id"]."'");
                        ...
                        <?php
                        $user_rs = Database::select("SELECT * FROM `users` WHERE `email`='".$selected_data["user_mail"]."'");
